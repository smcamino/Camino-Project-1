...
Welcome! This is project 1 for St558 at NC State! Here you will see a vignette I have created about contacting a [NASA API](https://api.nasa.gov/index.html#browseAPI) using functions I wrote to query, parse, and return data. At the end will be a small exploratory analysis on the data I returned from the functions I created.  
